        ...
        child: Padding(
          ...
          child: Row(
            children: [
              ...
              Expanded(
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    // Viền Gradient 3D kết hợp trắng (mép trên-trái) & xám nhẹ (mép dưới-phải)
                    gradient: LinearGradient(
                      colors: isDark
                          ...
                          : [
                              Colors.white.withValues(alpha: 0.95), // Trắng phản quang góc trên
                              Colors.white.withValues(alpha: 0.50),
                              const Color(0xFF94A3B8).withValues(alpha: 0.65), // Xám nhẹ góc dưới
                            ],
                  ...
                  child: Container(
                    margin: const EdgeInsets.all(1.5), // Độ dầy viền Gradient 1.5px
                    decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(9999),
                    ),
                    child: ClipRRect(
                      ...
                      child: BackdropFilter(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            // Phông nền trong suốt mờ mờ y như ảnh mẫu!
                            color: isDark
              ...
              // 4. Separate Floating AI Action Button (62x62px Glass Button with Gradient White-to-Grey Border)
              Builder(
                builder: (context) {
                  ...
                  return GestureDetector(
                    ...
                    child: AnimatedScale(
                      ...
                      child: Container(
                        ...
                        child: Container(
                          margin: EdgeInsets.all(isAiActive ? 0 : 1.5),
