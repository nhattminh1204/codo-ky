...
- **Motion System, Liquid Glass Dock & Camera AI Scanner**: 🟢 Hoàn thiện (Chuẩn hóa tại `lib/core/theme/motion.dart`: AppMotion.micro 150ms, AppMotion.standard 300ms, AppMotion.standardCurve, Liquid Glassmorphic Navigation Capsule với 5 cột bằng nhau cân đối, Nút Camera AI Scanner chụp ảnh thực tế `image_picker` ở trung tâm, isolated press state 0.88, flutter test pass 87/87 tests 100%).
